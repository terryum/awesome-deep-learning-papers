...
* [Theory / Understanding](#theory).
* [Optimization / Regularization](#opt).
* [CNN Models](#cnn).
* [Image / Scene](#image).
* [Video / Caption](#video).
* [Human Activity](#human).
* [Word Embedding](#word).
* [Machine Translation / NLP etc.](#nlp).
* [Speech / Other Applications](#speech).
* [RL / Robotics](#rl).
* [Unsupervised](#unsupervised).
* [Hardware / Software](#hwsw).
